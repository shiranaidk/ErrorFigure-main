...
extends CFont {
    ...
    public void drawStringWithAdvancedShadow(String text, float x, float y, int iteration, int color) {
        for (int i = 1; i <= iteration; i++) {
            drawString(text, x + i * 0.5f, y + i * 0.5f, new Color(30, 30, 30, 200 / iteration).getRGB());
        }
        drawString(text, x, y, color);
    }

    public void drawStringWithAdvancedShadow(String text, double x, double y, int iteration, int color) {
        for (int i = 1; i <= iteration; i++) {
            drawString(text, x + i * 0.5, y + i * 0.5, new Color(30, 30, 30, 200 / iteration).getRGB(), false);
        }
        drawString(text, x, y, color, false);
    }

    public void drawCenteredStringWithAdvancedShadow(String text, float x, float y, int iteration, int color) {
        for (int i = 1; i <= iteration; i++) {
            drawCenteredString(text, x + i * 0.5f, y + i * 0.5f, new Color(30, 30, 30, 200 / iteration).getRGB());
        }
