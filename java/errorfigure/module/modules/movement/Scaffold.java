...
//            mc.thePlayer.rotationPitchHead = rotation.getPitch();
            ...
            if (PlayerUtils.isAirUnder((Entity) mc.thePlayer) && MoveUtils.isOnGround((double) 1.15)
                    && mc.gameSettings.keyBindJump.isKeyDown() && !PlayerUtils.MovementInput()
    ...
    public void on2D(EventRender2D event) {
        ...
        FontLoaders.kiona18.drawString(String.valueOf(getBlockCount() + getallBlockCount()),
                middleX + 10
                        - FontLoaders.kiona18.getStringWidth(String.valueOf(getBlockCount() + getallBlockCount())) / 2,
