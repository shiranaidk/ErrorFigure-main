   ...
   public void setEnabled(boolean enabled) {
      ...
      if(enabled) {
         this.onEnable();
          ...
          NotificationManager.show(new Notification(NotificationType.INFO, "Enabled " + getName(), 1));
      } else {
          NotificationManager.show(new Notification(NotificationType.ERROR, "Disabled " + getName(), 1));
   ...
   public void makeCommand() {
      if(this.values.size() > 0) {
         ...
         while(true) {
            do {
               if(!var4.hasNext()) {
                  Client.instance.getCommandManager().add(new Module$1(this, this.name, null, String.format("%s%s", new Object[]{options.isEmpty()?"":String.format("%s,", new Object[]{options}), other.isEmpty()?"":String.format("%s", new Object[]{other})}), "Setup this module"));
                  return;
               }
