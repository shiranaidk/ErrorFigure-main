...
import errorfigure.module.modules.combat.HitBox;
import errorfigure.module.modules.movement.Scaffold;
import errorfigure.module.modules.world.Blink;
import errorfigure.module.modules.world.SafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled();;
    ...
    {
        if (this instanceof EntityPlayer && ModuleManager.getModuleByClass(HitBox.class).isEnabled() && !ModuleManager.getModuleByClass(Blink.class).isEnabled()) {
